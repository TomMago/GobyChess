...
def set_board():
    ...
    for i, j in itertools.product(range(2), range(6)):
        board.pieces[i][j] = np.uint64(board.pieces[i][j])

    board.all_pieces = np.uint64(board.all_pieces)
    board.all_pieces_color[0] = np.uint64(board.all_pieces_color[0])
    board.all_pieces_color[1] = np.uint64(board.all_pieces_color[1])
...
def test_rook_sliding(set_board):
    ...
    gen_attack_bitboard = mvg.rook_sliding(square, set_board[0].all_pieces, set_board[1], set_board[2])
...
def test_bishop_sliding(set_board):
    ...
    gen_attack_bitboard = mvg.bishop_sliding(square, set_board[0].all_pieces, set_board[1], set_board[2])
    assert gen_attack_bitboard == attack_bitboard
...
def test_gen_bishop_moves(set_board):
    black_moves = len(mvg.gen_bishop_moves(set_board[0].pieces[0][2],
                                           set_board[0].all_pieces,
                                           set_board[0].all_pieces_color[0],
                                           set_board[1], set_board[2]))

    assert black_moves == 14

    white_moves = len(mvg.gen_bishop_moves(set_board[0].pieces[1][2],
                                           set_board[0].all_pieces,
...
def test_gen_rook_moves(set_board):
    black_moves = len(mvg.gen_rook_moves(set_board[0].pieces[0][3],
                                         set_board[0].all_pieces,
                                         set_board[0].all_pieces_color[0],
                                         set_board[1], set_board[2]))
    ...
    white_moves = len(mvg.gen_rook_moves(set_board[0].pieces[1][3],
                                         set_board[0].all_pieces,
                                         set_board[0].all_pieces_color[1],
                                         set_board[1], set_board[2]))
...
def test_gen_queen_moves(set_board):
    black_moves = len(mvg.gen_queen_moves(set_board[0].pieces[0][4],
                                          set_board[0].all_pieces,
                                          set_board[0].all_pieces_color[0],
                                          set_board[1], set_board[2]))
    ...
    white_moves = len(mvg.gen_queen_moves(set_board[0].pieces[1][4],
                                          set_board[0].all_pieces,
                                          set_board[0].all_pieces_color[1],
                                          set_board[1], set_board[2]))
